            ...
            <div className='topHeader'>
                <div className="container-fluid">
                    ...
                    <div className="row knowledgetitle justify-content-center align-items-center">
                        ...
                        <h4 className='text-white mb-0 py-3'>999.9 Gold Selling Price HK$ 25,680 / tael</h4>

                            <div className="pagination-container testimonial-right d-flex flex-wrap position-absolute">
                                <div className="onlinecall ms-auto">
                                    <img src={videoicon} alt="" />
                                    <button className='Virtual text-uppercase'>Virtual factory visit</button>
                                </div>
                            </div>
                        </div>
                    </div>
